...
type AppointmentCreatedConsumer struct {
...
func NewAppointmentCreatedConsumer(amqpURL, queueName string, sender outbound.EmailSender, logger *logrus.Logger) (*AppointmentCreatedConsumer, error) {
	...
	return &AppointmentCreatedConsumer{
		conn:        conn,
		channel:     ch,
		queueName:   queueName,
		emailSender: sender,
...
func (c *AppointmentCreatedConsumer) Consume(ctx context.Context) error {
